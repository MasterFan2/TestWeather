...
/**
 * Helper class for showing and canceling push message
 * notifications.
 * <p/>
 * This class makes heavy use of the {@link NotificationCompat.Builder} helper
 * class to create notifications in a backward-compatible way.
 */
public class TestPushMessageNotification {
     ...
     * presentation of push message notifications. Make
     * sure to follow the
     ...
     * @see #cancel(Context)
     */
    public static void notify(final Context context, final String strTitle, final String strContent, final int toPage, final int number) {
        ...
        final String ticker = strTitle;
        final String title = strTitle;
        final String text = strContent;
